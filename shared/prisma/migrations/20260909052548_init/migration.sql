-- CreateEnum
CREATE TYPE "Role" AS ENUM ('LEARNER', 'INSTRUCTOR', 'ADMIN', 'SUPPORT');

-- CreateEnum
CREATE TYPE "CourseFormat" AS ENUM ('SELF_PACED', 'LIVE', 'BUNDLE');

-- CreateEnum
CREATE TYPE "DoubtStatus" AS ENUM ('OPEN', 'ANSWERED');

-- CreateEnum
CREATE TYPE "LiveSessionType" AS ENUM ('CLASS', 'WEBINAR');
...
-- CreateIndex
CREATE UNIQUE INDEX "Attendance_userId_liveSessionId_key" ON "Attendance"("userId", "liveSessionId");
...
-- AddForeignKey
ALTER TABLE "Doubt" ADD CONSTRAINT "Doubt_liveSessionId_fkey" FOREIGN KEY ("liveSessionId") REFERENCES "LiveSession"("id") ON DELETE SET NULL ON UPDATE CASCADE;
